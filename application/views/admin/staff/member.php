                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active " id="tab_profile">
                                    ...
                                    <div class="row col-md-12">
                                        <!-- Departments - Narrower Column -->
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <?php if (count($departments) > 0) { ?>
                                                <label for="departments"><?= _l('staff_add_edit_departments'); ?></label>
                                                <?php } ?>
                                                <div style="max-height: 150px; overflow-y: auto; border: 1px solid #e4e5e7; padding: 10px; border-radius: 4px;">
                                                    <?php foreach ($departments as $department) { ?>
                                                    <div class="checkbox checkbox-primary">
                                                        <input type="checkbox"
                                                            id="dep_<?= e($department['departmentid']); ?>"
                                        ...
                                        <!-- Custom Fields - Wider Column -->
                                        <div class="col-md-4">
                                            <?php $rel_id = (isset($member) ? $member->staffid : false); ?>
                                            <?= render_custom_fields('staff', $rel_id); ?>
                                        </div>
                                        <!-- Email Signature - Wider Column -->
                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1"
                                                    data-toggle="tooltip"
                                    ...
                                    <input type="text" class="fake-autofill-field col-md-3" name="fakeusernameremembered"
                                        value='' tabindex="-1" />
                                    <input type="password" class="fake-autofill-field col-md-3" name="fakepasswordremembered"
                                        value='' tabindex="-1" />
                                    <div class="clearfix form-group col-md-3"></div>
                                    <label for="password"
