                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6 border-right">
                                ...
                                <div class="row">
                                    <div class="form-group select-placeholder col-md-4 <?php if ($rel_id == '') {
                                        echo ' hide';
                                        } ?> " id="rel_id_wrapper">
                                    ...
                                    <div
                                        class="form-group select-placeholder projects-wrapper col-md-4 <?= ((! isset($proposal)) || (isset($proposal) && $proposal->rel_type !== 'customer')) ? 'hide' : '' ?>">
                                        <label
                            ...
                            <div class="col-md-6">
                                ...
                                <?= render_textarea('address', 'proposal_address', $value, ['rows' => 2]); ?>
                                <div class="row">
                                    <div class="col-md-4">
