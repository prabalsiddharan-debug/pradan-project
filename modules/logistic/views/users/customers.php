            ...
            <div class="col-md-12">
                <div class="_buttons">
                    ...
                    <div id="vueApp" class="tw-inline pull-right tw-ml-0 sm:tw-ml-1.5">
                            <app-filters 
                                id="<?php echo lg_html_entity_decode($table->id()); ?>" 
                                view="<?php echo lg_html_entity_decode($table->viewName()); ?>"
                                :saved-filters="<?php echo lg_html_entity_decode($table->filtersJs()); ?>"
                                :available-rules="<?php echo lg_html_entity_decode($table->rulesJs()); ?>">
                        </app-filters>
                </div>
                </div>
                <div class="clearfix"></div>
                                ...
                                <div
                                    ...
                                    <span class="text-muted tw-truncate" data-toggle="tooltip"
                                        ...
                                        <span<?php if ($contactsTemplate != '') { ?> class="pointer text-has-action"
                                            data-toggle="popover"
                                            data-title="<?php echo _l('customers_summary_logged_in_today'); ?>"
                                            data-html="true" data-content="<?php echo lg_html_entity_decode($contactsTemplate); ?>"
