	                    ...
	                    <div class="panel-body">
                        	...
                        	<div class="row">
                        		<div class="col-md-6">
                        			...
                        			<?php $customer_id = (isset($shipment) ? $shipment->customer_id : '');
	            	...
	            	<div class="panel_s panel-table-full">
	                    <div class="panel-body">
                        	...
                        	<div class="row">
                                ...
                                <?php if($multiple == 0 && !isset($shipment)){ ?>
				                        ...
				                        <select name="invoice_id" id="invoice_id" class="selectpicker" onchange="invoice_select(); return false;" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
				                          <option value=""></option>
				                          	<?php foreach($invoices as $inv) { ?>
				                          		<?php if(total_rows(db_prefix().'lg_shipments', ['invoice_id' => $inv['id']]) == 0){ ?>
	                    ...
	                    <div class="panel-body">
                        	...
                        	<div class="row mtop15 mbot15">
                        		...
                        		<div class="col-md-3 pad_right_0">
                        			...
                        			echo render_input('tax_percent', '', $tax_percent, 'number', ['onchange' => 'calculate_shipment(); return false;'], [], 'mbot5', 'tax_percent'); ?>
                        		...
                        		<div class="col-md-3 pad_right_0">
                        			...
                        			echo render_input('declared_value_percent', '', $declared_value_percent, 'number', ['onchange' => 'calculate_shipment(); return false;'], [], 'mbot5', 'declared_value_percent'); ?>
...
<?php init_tail(); ?>
<?php require 'modules/logistic/assets/js/shipping/shipment_js.php';?>