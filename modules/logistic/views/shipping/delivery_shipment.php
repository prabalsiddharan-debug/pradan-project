...
<div id="wrapper">
    <div class="content">
        <div class="row">
            ...
            <?php echo form_open_multipart($this->uri->uri_string(),array('id'=>'shipment_tracking_shipping-form')); ?>

            <?php $shipping_id = $shipping->id;
            echo form_hidden('shipping_id', $shipping_id); ?>

            <div class="col-md-12">
                <div class="panel_s panel-table-full">
                    <div class="panel-body">
                        <h4 class="no-margin font-bold"><?php echo '<span class="text-danger">'._l('lg_delivery_shipment_str').'</span> | '.$shipping->shipping_prefix.$shipping->number_code; ?></h4>
                        ...
                        <div id="sign_div" class="col-md-6 text-center mtop15">
                            <?php $this->load->view('shipping/shipping_shipment_sign'); ?>
                        </div>
        ...
        <div class="modal-body">
         <p class="bold" id="signatureLabel"><?php echo _l('signature'); ?></p>
          ...
          <div class="modal-footer">
           ...
           <button id="sign_button" onclick="sign_request(<?php echo lg_html_entity_decode($shipping->id); ?>);" data-loading-text="<?php echo _l('wait_text'); ?>" autocomplete="off" class="btn btn-success"><?php echo _l('e_signature_sign'); ?></button>
          </div>
...
<?php init_tail(); ?>
<?php require 'modules/logistic/assets/js/shipping/delivery_shipment_js.php';?>