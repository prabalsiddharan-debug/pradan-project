...
<div id="wrapper">
    <div class="content">
        <div class="row">
            ...
            <?php echo form_open($this->uri->uri_string(),array('id'=>'shipment_tracking_shipping-form')); ?>

            <?php $shipping_id = $shipping->id;
            echo form_hidden('rel_id', $shipping_id); ?>

            <div class="col-md-12">
                    <div class="panel_s panel-table-full">
                        <div class="panel-body">
                            <h4 class="no-margin font-bold"><?php echo '<span class="text-danger">'._l('lg_shipment_tracking').'</span> | '.$shipping->shipping_prefix.$shipping->number_code; ?></h4>
