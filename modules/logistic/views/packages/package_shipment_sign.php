<?php if(isset($shipment_sign->id)){ ?>
 ...
 <div class="col-md-2 text-left hide">
   <a href="javascript:void(0);" data-toggle="tooltip" title="<?php echo _l('lg_remove_sign'); ?>" onclick="remove_sign(<?php echo lg_html_entity_decode($package->id); ?>); return false;" class=" text-danger"><i class="fa fa-remove"></i></a>
 </div>
