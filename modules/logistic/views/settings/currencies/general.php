...
<?php 
 ...
 ?>
<div  class="row">
<?php echo form_open(admin_url('logistic/update_setting_currency_rate'),array('id'=>'general-settings-form')); ?>
    <div class="col-md-5">
...
<?php echo form_close(); ?>
	<div class="row">    
      <div class="_buttons col-md-12">
        ...
        <div class="col-md-6">
        	<a href="<?php echo admin_url('logistic/get_all_currency_rate_online'); ?>" class="btn btn-info pull-right mtop25" ><?php echo _l('get_online_currency_rates'); ?></a>
        </div>
    </div>
  </div>
	...
	<div  class="col-md-12">
		<table class="table table-currency_rates scroll-responsive">
			<thead>
				<tr>
					<th><?php echo _l('lg_type'); ?></th>
					<th><?php echo _l('lg_currency_rate'); ?></th>
					<th><?php echo _l('lg_updated_at'); ?></th>
				</tr>
			</thead>
			<tbody></tbody>
			<tfoot>
